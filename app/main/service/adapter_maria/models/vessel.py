import  sys
import os
from sqlalchemy import Column, Integer, String, DateTime, Boolean, Enum,Sequence
...
class Vessel(Base_lc_config):
    ...
    name = Column(String(16), unique=False, nullable=True)
    imo = Column(String(16), unique=False, nullable=True)
    vtype = Column(String(16), unique=False, nullable=True)
    flag= Column(String(16), unique=False, nullable=True)
    yearbuilt = Column(Integer, unique=False, nullable=True)
    shipyard= Column(String(16), unique=False, nullable=True)
    owner = Column(String(16), unique=False, nullable=True)
    operator = Column(String(16), unique=False, nullable=True)
    vclass = Column(String(16), unique=False, nullable=True)
    atex = Column(String(16), unique=False, nullable=True)
    ais = Column(String(16), unique=False, nullable=True)
    mmsi = Column(String(16), unique=False, nullable=True)
...
class Tank(Base_lc_config):
    ...
    id = Column(Integer, Sequence('id_seq'), primary_key = True)
    tank_name = Column(String(16), unique=False, nullable=True)
